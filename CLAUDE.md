...
- Sample display line: "The streets raised them. You take it from here."
...
Three cats are already written in-voice; use them for the seed (rescuers marked `is_placeholder: true` until they consent):
- **Karak** — male · 2 yrs · Deira. "Lived behind a cafeteria in Deira. Knows his name and yells it back. Fine with kids, firm about breakfast." Rescuer: Silvana (@straycatdubai).
- **Mango** — female · 3 yrs · Al Quoz. "Raised three kittens under a parked truck. The kittens are homed. It's her turn now, and she knows it." Rescuer: Kwagga (@kevinofdxb).
- **Batata** — male · 4 yrs · Satwa. "Bin-diver, reformed. Lost half a tail out there and none of the appetite. Wants a warm lap and a routine." Rescuer: Fawaz (Save Dubai Stray Cats). Vet-bill example: Modern Vet, Umm Suqeim · Bill #04211 · dental extraction AED 840 (AED 520 covered, AED 320 to go).
