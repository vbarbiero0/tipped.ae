...
export default async function PetsPage({
  ...
  return (
    <div className="max-w-[1160px] mx-auto px-6 md:px-8 pt-8 md:pt-12 pb-16 md:pb-[84px]">
      <div className="eyebrow mb-[14px]">RESCUED ACROSS THE UAE</div>
      ...
      <p className="font-sans font-medium text-[16px] leading-[1.65] text-cocoa/75 m-0 mb-8 max-w-[560px]">
        Every pet here was rescued by someone who knows and cares for them,
        and the health tags on each profile show exactly what&rsquo;s been
        done. You can adopt from anywhere in the world, or foster if
        you&rsquo;re in the UAE. The happy endings live on the{" "}
